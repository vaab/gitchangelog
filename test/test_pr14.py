...
class TestCrossBranchTags(BaseGitReposTest):
    ...
    def setUp(self):
        ...
        self.git.commit(message="new: first commit on develop branch", allow_empty=True)
        self.git.tag("0.0.2")

        self.git.commit(message="new: second commit on develop branch", allow_empty=True)
...
class TestLogLinearbility(BaseGitReposTest):
    ...
    def setUp(self):
        ...
        self.git.commit(message="new: commit on develop branch", allow_empty=True)
        self.git.tag("0.0.3")
