...
class EmptyMessageTest(BaseGitReposTest):
    def setUp(self):
        ...
        self.git.commit(message="", date="2017-02-20 11:00:00", allow_empty=True, allow_empty_message=True)
    ...
    def test_empty_message_default_changelog_accepted(self):
        gitchangelog.file_put_contents(".gitchangelog.rc", "ignore_regexps = []")
